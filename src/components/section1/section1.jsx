  ...
  return (
    <div className="container">
      <div className="mini-container">
        <img src={DisneyLogo} alt="disney-logo" style={{ marginTop: '10%' }} />
        <p
        ...
        <a href="https://www.disneyplus.com/sign-up?type=bundle" style={{ height: '10%', width: '80%' }}>
        ...
        <div style={{
          position: 'absolute', left: '0%', bottom: '15%', width: 'fit-content', height: 'fit-content', marginLeft: '2%',
        }}
        >
